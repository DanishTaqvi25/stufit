		  ...
		  <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" disabled id="exampleInputEmail1" value="Saif Khan">
                  </div>
              </div>
			   ...
			   <div class="col-md-6">
                <div class="form-group">
                    <label for="exampleInputEmail1">Gender</label>
					  <select name="demo" disabled class="form-control select2">
			  ...
			  <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" disabled id="exampleInputEmail1" value="A-8/15, Gomti Nager, Lucknow">
                  </div>
              </div>
			  ...
			  <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" disabled id="exampleInputEmail1" value="saif@gmail.com">
                  </div>
              </div>
			  ...
			  <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" disabled id="exampleInputEmail1" value="989855666">
                  </div>
              </div>
			  ...
			  <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" disabled id="exampleInputEmail1" value="Email">
                  </div>
              </div>
			   ...
			   <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" disabled id="exampleInputEmail1" value="Mohd Anwar Khan">
                  </div>
              </div>
			  ...
			  <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" disabled id="exampleInputEmail1" value="Noor Bano">
                  </div>
              </div>
			  ...
			  <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" disabled class="form-control" id="exampleInputEmail1" value="2">
                  </div>
              </div>
        ...
        <div class="card card-default " >
          ...
          <div class="card-body">
			...
			<label for="exampleInputEmail1">Height</label>
			 ...
			 <div class="col-md-3">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="400 cm">
                  </div>
              </div>
			...
			<label for="exampleInputEmail1"> Weight </label>
			 ...
			 <div class="col-md-3">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="90 kg">
                  </div>
              </div>
			...
			<label for="exampleInputEmail1">BMI</label>
			 ...
			 <div class="col-md-3">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="3 kg/m2">
                  </div>
              </div>
			...
			<label for="exampleInputEmail1">Body Temperature</label>
			 ...
			 <div class="col-md-3">
			  ...
			  <div class="col-md-3">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="23">
                  </div>
              </div>
			...
			<label for="exampleInputEmail1">Blood Pressure</label>
			  ...
			  <div class="col-md-3">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="80">
                  </div>
              </div>
			  
			   <div class="col-md-3">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="120">
                  </div>
              </div>
			...
			<label for="exampleInputEmail1">Pulse Rate</label>
			  ...
			  <div class="col-md-3">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="85">
                  </div>
              </div>
			...
			<label for="exampleInputEmail1">Oxygen Saturation</label>
			 ...
			 <div class="col-md-3">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="95%">
                  </div>
              </div>
			...
			<input type="radio" disabled name="Posture" id="GoodPosture">
			...
			<input type="radio" disabled name="Posture" id="BadPosture">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Posture" id="WorstPosture">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="UpperLimb" id="UpperNormal">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="UpperLimb" id="UpperRestricted">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="UpperLimb" id="UpperHypermoves">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="NeckLimb" id="NeckNormal">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="NeckLimb" id="NeckRestricted">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="NeckLimb" id="NeckHypermoves">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Both" id="BothNormal">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Both" id="BothRestricted">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Both" id="BothHypermoves">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Dystrophy" id="DystrophyYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Dystrophy" id="DystrophyNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Astrophy" id="radioDanger1">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Astrophy" id="radioDanger2">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Endurance" id="EnduranceGood">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Endurance" id="EnduranceNormal">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Endurance" id="EnduranceWeak">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Stamina" id="StaminaGood">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Stamina" id="StaminaNormal">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Stamina" id="StaminaWeak">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Pain" id="PainMuscular">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Pain" id="PainNormal">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Pain" id="PainWeak">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Pain" id="NoPain">
			...
			<label for="exampleInputEmail1">Pain Position</label>
			 ...
			 <div class="col-md-3">
                <div class="form-group">
                    <input disabled type="text" class="form-control" id="exampleInputEmail1" value="Pain Position">
                  </div>
              </div>
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Spasm" id="SpasmMild">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Spasm" id="SpasmHeavy">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Spasm" id="NoSpasm">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Spasm" id="SpasmNoPain">
			...
			<label for="exampleInputEmail1">Advice</label>
			 ...
			 <div class="col-md-6">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="Medical requirements may change based on the conditions">
                  </div>
              </div>
			...
			<label for="exampleInputEmail1">Remark</label>
			 ...
			 <div class="col-md-6">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="Good Recovery">
                  </div>
              </div>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default " >
          ...
          <div class="card-body">
			...
			<div class="col-md-3">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="Normal">
                  </div>
            </div>
			...
			<div class="col-md-3">
			  ...
			  <div class="col-md-3">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="Critical Damage">
                  </div>
              </div>
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="LeftVision" id="GoodVisionLeft">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked  name="LeftVision" id="BadVisionLeft">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="RightVision" id="GoodVisionRight">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="RightVision" id="BadVisionRight">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" checked name="LeftDisease" id="YesDiseaseLeft">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="LeftDisease" id="NoDiseaseLeft">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="RightDisease" id="RightDiseaseYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="RightDisease" id="RightDiseaseNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="LeftSquint" id="LeftSquintYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="LeftSquint" id="LeftSquintNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" checked name="RightSquint" id="RightSquintYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="RightSquint" id="RightSquintNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="LeftPtosis" id="LeftPtosisYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="LeftPtosis" id="LeftPtosisNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="RightPtosis" id="RightPtosisYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="RightPtosis" id="RightPtosisNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="LeftNystugmus" id="LeftNystugmusYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="LeftNystugmus" id="LeftNystugmusNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="RightNystugmus" id="RightNystugmusYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="RightNystugmus" id="RightNystugmusNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="LeftCataract" id="LeftCataractYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="LeftCataract" id="LeftCataractNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="RightCataract" id="RightCataractYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="RightCataract" id="RightCataractNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="LeftEyeBall" id="LeftEyeBallYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="LeftEyeBall" id="LeftEyeBallNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="RightEyeBall" id="RightEyeBallYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="RightEyeBall" id="RightEyeBallNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="LeftItching" id="LeftItchingYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="LeftItching" id="LeftItchingNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" checked name="RightItching" id="RightItchingYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="RightItching" id="RightItchingNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="LeftDryness" id="LeftDrynessYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="LeftDryness" id="LeftDrynessNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="RightDryness" id="RightDrynessYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="RightDryness" id="RightDrynessNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="LeftTears" id="LeftTearsYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="LeftTears" id="LeftTearsNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="RightTears" id="RightTearsYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="RightTears" id="RightTearsNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" checked name="LeftRedEyes" id="LeftRedEyesYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="LeftRedEyes" id="LeftRedEyesNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="RightRedEyes" id="RightRedEyesYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="RightRedEyes" id="RightRedEyesNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="LeftYellowishEyes" id="LeftYellowishEyesYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="LeftYellowishEyes" id="LeftYellowishEyesNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="RightYellowishEyes" id="RightYellowishEyesYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="RightYellowishEyes" id="RightYellowishEyesNo">
			...
			<div class="col-md-3">
			  ...
			  <div class="col-md-3">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="Critical Damaged">
                  </div>
              </div>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default " >
          ...
          <div class="card-body">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Caries" id="InitialCaries">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Caries" id="ModerateCaries">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Caries" id="AverageCaries">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Caries" id="NoCariesCaries">
			...
			<label for="exampleInputEmail1">Periodontal</label>
			 ...
			 <div class="col-md-3">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="Periodontal">
                  </div>
              </div>
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Orthodontic" id="Advised">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Orthodontic" id="NotAdvised">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Extraction" id="AdvisedExtraction">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Extraction" id="NotAdvisedExtraction">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="SpaceMaintainer" id="AdvisedSpaceMaintainer">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="SpaceMaintainer" id="NotAdvisedSpaceMaintainer">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" checked name="OralHygieneStatus" id="GoodOralHygieneStatus">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="OralHygieneStatus" id="BadOralHygieneStatus">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="SpaceMaintainer" id="AverageOralHygieneStatus">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="SugarIntake" id="SugarIntakeYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="SugarIntake" id="SugarIntakeNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" checked name="Brushed" id="OnceBrushed">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Brushed" id="TwiceBrushed">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Brushed" id="NotBrushed">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Malpositioned" id="MalpositionedYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Malpositioned" id="MalpositionedNo">
			...
			<label for="exampleInputEmail1">Specify</label>
			 ...
			 <div class="col-md-3">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="Specify">
                  </div>
              </div>
        ...
        <div class="card card-default " >
          ...
          <div class="card-body">
			...
			<label for="exampleInputEmail1">Speech Milestone</label>
			 ...
			 <div class="col-md-3">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="Speak Too Much">
                  </div>
              </div>
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Comprehension" id="VerbalComprehension">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Comprehension" id="NonVerbalComprehension">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Comprehension" id="GestureComprehension">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Comprehension" id="LanguageComprehension">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Expression" id="VerbalExpression">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Expression" id="NonVerbalExpression">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Expression" id="GestureExpression">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Expression" id="LanguageExpression">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Communication" id="VerbalCommunication">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Communication" id="NonVerbalCommunication">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Auditory" id="ProperAuditory">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked  name="Auditory" id="ImproperAuditory">
			...
			<div class="icheck-primary d-inline  radiocssfirst">
			<input type="radio" disabled name="Hearing" id="HearingYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Hearing" id="HearingNo">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Hearing" id="HearingStatic">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Hearing" id="HearingProgressive">
			...
			<div class="icheck-primary d-inline  radiocssfirst">
			<input type="radio" disabled name="Tinnitus" id="YesTinnitus">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Tinnitus" id="NoTinnitus">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Ear" id="YesEar">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Ear" id="NoEar">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="WhichEar" id="WhichEarRight">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="WhichEar" id="WhichEarLeft">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="WhichEar" id="WhichEarBoth">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Call" id="YesCall">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Call" id="NoCall">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Hearing" id="PTAHearing">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Hearing" id="BOAHearing">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Hearing" id="VRAHearing">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Hearing" id="AVRHearing">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Bilateral" id="YesBilateral">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Bilateral" id="NoBilateral">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="MedicalHistory" id="YesMedicalHistory">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="MedicalHistory" id="NoMedicalHistory">
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default " >
          ...
          <div class="card-body">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="PaleSkin" id="PaleSkinYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="PaleSkin" id="PaleSkinNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Heartbeats" id="HeartbeatsYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Heartbeats" id="HeartbeatsNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Shortness" id="ShortnessYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Shortness" id="ShortnessNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Dizziness" id="DizzinessYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Dizziness" id="DizzinessNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="ColdHands" id="ColdHandsYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="ColdHands" id="ColdHandsNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Anemia" id="AnemiaSymptomaticYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Anemia" id="AnemiaNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Fatigue" id="FatigueYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Fatigue" id="FatigueNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Deficiency" id="DeficiencySymptomatic">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Deficiency" id="DeficiencyNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Obesity" id="ObesityYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Obesity" id="ObesityNo">
			...
			<label for="exampleInputEmail1">Ideal Body Weight</label>
			 ...
			 <div class="col-md-3">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="76">
                  </div>
              </div>
			...
			<label for="exampleInputEmail1">Ideal Calories Estimation / Day</label>
			 ...
			 <div class="col-md-3">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="200">
                  </div>
              </div>
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="MicroNutrient" id="MicroNutrientFats">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="MicroNutrient" id="MicroNutrientProtien">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="MicroNutrient" id="MicroNutrientCarbohydrates">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="FluidEstimation" id="MLFluidEstimation">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="FluidEstimation" id="GLASSESFluidEstimation">
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default " >
          ...
          <div class="card-body">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Chest" id="ChestClear">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Chest" id="ChestNotClear">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Abdomen" id="AbdomenTender">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Abdomen" id="AbdomenSoft">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Abdomen" id="AbdomenDistended">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Abdomen" id="AbdomenNormal">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="AbdomenPalpitation" id="AbdomenPalpitationYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="AbdomenPalpitation" id="AbdomenPalpitationNo">
			...
			<label for="exampleInputEmail1">Body Temperature</label>
			 ...
			 <div class="col-md-3">
			  ...
			  <div class="col-md-3">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="Temperature">
                  </div>
              </div>
			...
			<label for="exampleInputEmail1">Active Infectious Disease</label>
			 ...
			 <div class="col-md-3">
                <div class="form-group">
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="Disease">
                  </div>
              </div>
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Cleft" id="CleftYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Cleft" id="CleftNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Club" id="ClubYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Club" id="ClubNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Congenital" id="CongenitalYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Congenital" id="CongenitalNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Deafness" id="DeafnessYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Deafness" id="DeafnessNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="SkinCondition" id="YesSkinCondition">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="SkinCondition" id="NoSkinCondition">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Otitis" id="OtitisYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Otitis" id="OtitisNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="NeuroMotor" id="YesNeuroMotor">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="NeuroMotor" id="NoNeuroMotor">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="BodyType" id="BodyTypeThin">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="BodyType" id="BodyTypeAverage">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="BodyType" id="FatyBodyType">
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default " >
          ...
          <div class="card-body">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Annoyed" id="YesAnnoyed">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Annoyed" id="NoAnnoyed">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Angry" id="YesAngry">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Angry" id="NoAngry">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Blame" id="YesBlame">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Blame" id="NoBlame">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" checked name="Authorities" id="YesAuthorities">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Authorities" id="NoAuthorities">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Tantrums" id="YesTantrums">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Tantrums" id="NoTantrums">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Frustations" id="YesFrustations">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Frustations" id="NoFrustations">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" checked name="Behaviour" id="YesBehaviour">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Behaviour" id="NoBehaviour">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Spelling" id="YesSpelling">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Behaviour" id="NoSpelling">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Paraphrasing" id="YesParaphrasing">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio"  checked name="Paraphrasing" id="NoParaphrasing">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="PoorMemory" id="YesPoorMemory">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="PoorMemory" id="NoPoorMemory">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Surroundings" id="FriendlySurroundings">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Surroundings" id="NotSurroundings">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Quite" id="QuiteYes">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Quite" id="QuiteNo">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" checked name="Fidgetting" id="YesFidgetting">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" disabled name="Fidgetting" id="NoFidgetting">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="ConcentrateOnTask" id="YesConcentrateOnTask">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="ConcentrateOnTask" id="NoConcentrateOnTask">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="PhysicalMovements" id="YesPhysicalMovements">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="PhysicalMovements" id="NoPhysicalMovements">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="ExcessiveTalking" id="YesExcessiveTalking">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="ExcessiveTalking" id="NoExcessiveTalking">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Wait" id="YesWait">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Wait" id="NoWait">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Acting" id="YesActing">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Acting" id="NoActing">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Interruption" id="YesInterruption">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Interruption" id="NoInterruption">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Deficite" id="YesDeficite">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Deficite" id="NoDeficite">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="SelfEsteem" id="YesSelfEsteem">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="SelfEsteem" id="NoSelfEsteem">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="IrritableActions" id="YesIrritableActions">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="IrritableActions" id="NoIrritableActions">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="SuddenAnger" id="YesSuddenAnger">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="SuddenAnger" id="NoSuddenAnger">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="FrequentAbsence" id="YesFrequentAbsence">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="FrequentAbsence" id="NoFrequentAbsence">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Suicide" id="YesSuicide">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Suicide" id="NoSuicide">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="RecklessBehaviour" id="YesRecklessBehaviour">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="RecklessBehaviour" id="NoRecklessBehaviour">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="CryingFrequently" id="YesCryingFrequently">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="CryingFrequently" id="NoCryingFrequently">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Depression" id="YesDepression">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Depression" id="NoDepression">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Edge" id="YesEdge">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Edge" id="NoEdge">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="SocialChanges" id="YesSocialChanges">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="SocialChanges" id="NoSocialChanges">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="PhysicalChanges" id="YesPhysicalChanges">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="PhysicalChanges" id="NoPhysicalChanges">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="SleepDisturbance" id="YesSleepDisturbance">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="SleepDisturbance" id="NoSleepDisturbance">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="PoorSchool" id="YesPoorSchool">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="PoorSchool" id="NoPoorSchool">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="PanicAttack" id="YesPanicAttack">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="PanicAttack" id="NoPanicAttack">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Anxiety" id="YesAnxiety">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Anxiety" id="NoAnxiety">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Performance" id="YesPerformance">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Performance" id="NoPerformance">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="AboutAppearence" id="YesAboutAppearence">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="AboutAppearence" id="NoAboutAppearence">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="ComparesSelf" id="YesComparesSelf">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="ComparesSelf" id="NoComparesSelf">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Ugly" id="YesUgly">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Ugly" id="NoUgly">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="PerfectImage" id="YesPerfectImage">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="PerfectImage" id="NoPerfectImage">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Incessant" id="YesIncessant">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio"  checked name="Incessant" id="NoIncessant">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Emotions" id="YesEmotions">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Emotions" id="NoEmotions">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Intolerence" id="YesIntolerence">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Intolerence" id="NoIntolerence">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="TimeAlone" id="YesTimeAlone">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="TimeAlone" id="NoTimeAlone">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="PullsBack" id="YesPullsBack">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="PullsBack" id="NoPullsBack">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio"  disabled name="Modelling" id="YesModelling">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Modelling" id="NoModelling">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Ask" id="YesAsk">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Ask" id="NoAsk">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="WeightGain" id="YesWeightGain">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="WeightGain" id="NoWeightGain">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Abdominal" id="YesAbdominal">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Abdominal" id="NoAbdominal">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Bloated" id="YesBloated">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Bloated" id="NoBloated">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Circles" id="YesCircles">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Circles" id="NoCircles">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Bathroom" id="YesBathroom">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Bathroom" id="NoBathroom">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Phobia" id="YesPhobia">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Phobia" id="NoPhobia">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="MobileAddiction" id="YesMobileAddiction">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="MobileAddiction" id="NoMobileAddiction">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="MemoryLoss" id="YesMemoryLoss">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="MemoryLoss" id="NoMemoryLoss">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Substance" id="YesSubstance">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Substance" id="NoSubstance">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="MeasurationCycle" id="YesMeasurationCycle">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="MeasurationCycle" id="NoMeasurationCycle">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="IrregularPeriod" id="YesIrregularPeriod">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="IrregularPeriod" id="NoIrregularPeriod">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="PainDuring" id="YesPainDuring">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="PainDuring" id="NoPainDuring">
			...
			<div class="icheck-primary d-inline radiocssfirst">
			<input type="radio" disabled name="Urination" id="YesUrination">
			...
			<div class="icheck-primary d-inline radiocss">
			<input type="radio" checked name="Urination" id="NoUrination">
			...
			<label for="exampleInputEmail1">Advice</label>
			 ...
			 <div class="col-md-6">
                <div class="form-group">
                    <input disabled type="text" class="form-control" id="exampleInputEmail1" value="Medical requirements may change based on the conditions">
                  </div>
              </div>
