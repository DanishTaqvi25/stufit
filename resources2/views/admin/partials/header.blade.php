    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
			...
			<li class="nav-item">
			  <a href="{{url('admin-dashboard')}}" class="nav-link <?php if($highlight=='dashboard'){echo 'active';} ?>">
			...
			<li class="nav-item">
			  <a href="{{url('school')}}" class="nav-link <?php if($highlight=='school'){echo 'active';} ?>">
			...
			<li class="nav-item">
			  <a href="{{url('employ')}}" class="nav-link <?php if($highlight=='employ'){echo 'active';} ?>">
			...
			<li class="nav-item">
			  <a href="{{url('student')}}" class="nav-link <?php if($highlight=='student'){echo 'active';} ?>">
