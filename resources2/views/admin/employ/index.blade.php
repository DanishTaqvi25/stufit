			...
			<div class="col-md-12">
			  ...
			  <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" name="mobile" oninput="this.value = this.value.replace(/[^0-9-+]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" maxlength = "10" class="form-control" id="exampleInputEmail1" value="{{$orderDetails->mobile}}">
                  </div>
              </div>
			 ...
			 <!-- <div class="col-md-12">
			  ...
			  <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input id="passwordInput2" name="password" type="text" name="password" class="form-control" value="{{$orderDetails->password}}">
                  </div>
              </div>
			...
			<div class="col-md-12">
              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="employ_name" maxlength = "50" class="form-control" id="exampleInputEmail1" placeholder="Employ Name">
                  </div>
              </div>
			  @csrf
			  ...
			  <div class="col-md-6">
                <div class="form-group">
                    <label for="exampleInputEmail1">Email</label>
                    <input type="email" name="email" maxlength = "50" class="form-control" id="exampleInputEmail1" placeholder="Email">
                  </div>
              </div>
			  ...
			  <div class="col-md-6">
                <div class="form-group">
                    <label for="exampleInputEmail1">Mobile</label>
                    <input type="number" name="mobile" oninput="this.value = this.value.replace(/[^0-9-+]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" maxlength = "10" class="form-control" id="exampleInputEmail1" placeholder="989855666">
                  </div>
              </div>
			   ...
			   <div class="col-md-6">
                <div class="form-group">
                    <label for="exampleInputEmail1">Address</label>
                    <input type="text" name="address" maxlength = "100" class="form-control" id="exampleInputEmail1" placeholder="Address">
                  </div>
              </div>
			  ...
			  <div class="col-md-6">
                <div class="form-group">
                    <label for="exampleInputEmail1">Password</label>
                    <input type="text" id="passwordInput"  name="password" class="form-control" value="">
                  </div>
              </div>
