            ...
            <div class="row">
              <div class="col-5 col-sm-3" style="background:#f2f2f2;">
                <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
					...
					<!--
					<a class="nav-link side-link" id="vert-tabs-profile-tab" data-toggle="pill" href="#vert-tabs-profile" role="tab" aria-controls="vert-tabs-profile" aria-selected="false">Documents</a>
				    <a class="nav-link side-link" id="vert-tabs-experience-tab" data-toggle="pill" href="#vert-tabs-experience" role="tab" aria-controls="vert-tabs-experience" aria-selected="false">Employees</a>
...
<input type="number" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "10" id="exampleInputPassword1" placeholder="Mobile No">
</div>
</div>
</div>
...
<div class="col-md-4">
<div class="form-group">
<label for="exampleInputPassword1">Emergency No</label>
<input type="number" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "10" id="exampleInputPassword1" placeholder="Emergency No">
</div>
</div>
...
<div class="col-md-4">
<div class="form-group">
<label for="exampleInputPassword1">House No. & Building</label>
<input type="text" class="form-control" id="exampleInputPassword1" placeholder="House No. & Building">
</div>
</div>
...
<div class="col-md-4">
<div class="form-group">
<label for="exampleInputPassword1">Location / Area</label>
<input type="text" class="form-control" id="exampleInputPassword1" placeholder="Location / Area">
</div>
</div>
   ...
   <div class="col-md-4">
	<div class="form-group">
		<label for="exampleInputEmail1">City</label>
		  <select name="demo" class="form-control select2">
			  <option value="3" selected >Select City</option>
...
<div class="col-md-4">
 <div class="form-group">
                    <label for="exampleInputEmail1">State</label>
					  <select name="demo" class="form-control select2">
                          <option value="3" selected >Select State</option>
...
<div class="form-group">
	<label for="exampleInputEmail1">Pincode</label>
	  <select name="demo" class="form-control select2">
		  <option value="3" selected >Select Pincode</option>
		  <option value="3">226016</option>
		  <option value="3" >225333</option>
		  <option value="3" >215544</option>
	  </select> 
</div>
</div>
...
<div class="form-group">
	<label for="exampleInputEmail1">Address Type</label>
	  <select name="demo" class="form-control select2">
		  <option value="3" selected >Select Address Type</option>
		  ...
		  <option value="3" >Office</option>
             ...
             <a href="javascript:void()" data-toggle="modal" data-target="#user-otp" > <button type="button" class="btn  bg-gradient-primary btn-position">Submit</button></a>
            </div>
                ...
                <table id="example3" class="table table-bordered table-striped">
                  ...
                  <tbody>
					...
					<tr>
						...
						<td>
							<img src="https://meraorder.co.in/uploads/vendor/profile/965381643266540160.png" class="img-fluid mb-2" alt="" style="height: 100px;" />					  </td>
						</td> 
						<td>
					...
					<tr>
						...
						<td>
							<select onchange="change_profile_status('187',this.value,'profile_status');" class="form-control">
							<option value="3" selected   >Pending</option>
