<footer class="main-footer">
    Copyright &copy; 2022 - Stufit - All Rights Reserved
</footer>
...
<script src="{{url('assets/adminlte/plugins/jquery-mousewheel/jquery.mousewheel.js')}}"></script>
<script src="{{url('assets/adminlte/plugins/raphael/raphael.min.js')}}"></script>
<script src="{{url('assets/adminlte/plugins/jquery-mapael/jquery.mapael.min.js')}}"></script>
<script src="{{url('assets/adminlte/plugins/jquery-mapael/maps/usa_states.min.js')}}"></script>
...
<script src="{{url('assets/adminlte/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js')}}"></script>
<!-- InputMask -->
<script src="{{url('assets/adminlte/plugins/inputmask/min/jquery.inputmask.bundle.min.js')}}"></script>
<!-- date-range-picker -->
...
<script src="{{url('assets/adminlte/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js')}}"></script>
<!-- Bootstrap Switch -->
<script src="{{url('assets/adminlte/plugins/bootstrap-switch/js/bootstrap-switch.min.js')}}"></script>
