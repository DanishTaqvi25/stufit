            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <tr>
                    <td><a href="{{url('view-school-student-details/'.$orderDetails->id)}}"><button type="button" class="btn  bg-gradient-primary">{{$orderDetails->student_id}}</button></a></td>
					 <td>{{$orderDetails->student_Name}}</td>
					 <td><?php $result = DB::table('schools')->where('id',$orderDetails->school_Name)->get();
