			...
			<div class="col-md-12">
			  ...
			  <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input id="passwordupdate" type="text" name="password" maxlength = "50" class="form-control" value="<?php echo $orderDetails->password;?>">
                  </div>
              </div>
           ...
           <section class="content">
			...
			<div class="col-md-12">
			  ...
			  <div class="col-md-6">
                <div class="form-group">
                    <label for="exampleInputEmail1">Password</label>
                    <input id="passwordInput" type="text" name="password" class="form-control" maxlength = "50" value="" required>
                  </div>
              </div>
