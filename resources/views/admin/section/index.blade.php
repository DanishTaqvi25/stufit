	 ...
	 <section class="content">
      <div class="container-fluid">
        ...
        <div class="modal-dialog ">
          <div class="modal-content ">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <a href="{{url('section-delete/'.$orderDetails->id)}}"><button type="button" class="btn btn-primary" style="width:104px;">Yes</button></a>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
        <!-- /.modal-dialog -->
			...
			<form action="{{url('post-update-section')}}" method="post">
	   <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="section" class="form-control" id="exampleInputEmail1" value="{{$orderDetails->section}}">
      ...
      <!-- /.container-fluid -->
	   ...
	   <form action="{{url('add-section')}}" method="post">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
           ...
           <section class="content">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="form-group">
                    <label for="exampleInputEmail1">Section Name</label>
                    <input type="text" class="form-control" name="section" id="exampleInputEmail1" placeholder="Section Name" required>
                  </div>
              </div>
