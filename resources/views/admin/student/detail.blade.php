		  ...
		  <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" disabled class="form-control" id="exampleInputEmail1" value="Saif Khan">
                    <input type="hidden" class="form-control" id="exampleInputEmail1" value="Saif Khan">
                  </div>
              </div>
