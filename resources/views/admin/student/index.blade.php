        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <a href="{{url('add-student')}}"><button type="button" class="btn  bg-gradient-primary btn-position">Add Student</button></a>
            </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach($student as $key => $orderDetails)
                  <tr>
                    <td><a href="javascript:void()"><button type="button" class="btn  bg-gradient-primary">{{$orderDetails->student_id}}</button></a></td>
                    <td>{{$orderDetails->student_Name}}</td>
					 <td><?php
					 $result = DB::table('schools')->where('id',$orderDetails->school_Name)->get();
                          echo $result[0]->school_name;
					?></td>
                    <td>{{$orderDetails->emergency}}</td>
					<td>27-01-2022 06:54 AM</td>
					
                     <td>
                         
						 <a class="btn btn-info btn-sm" href="{{url('edit-student/'.$orderDetails->id)}}">
                              <i class="fas fa-edit">
                              </i>
                              
                          </a>
                         
                          <!--<a class="btn btn-primary btn-sm" href="{{url('generate-pdf')}}">
                              <i class="fas fa-download">
                              </i>
                              
                          </a> -->
						  
						  <a class="btn btn-primary btn-sm" href="{{url('generate-pdf/'.$orderDetails->id)}}">
                              <i class="fas fa-download">
                              </i>
